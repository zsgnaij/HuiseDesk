        ...
        {isNavOpen && (
          ...
          >
            ...
            <nav style={styles.navLinks}>
              ...
              <Link to="/shotgrid" style={styles.navLink}>ShotGrid</Link>
              <Link to="/mdt" style={styles.navLink}>大数据表格</Link>
              <Link to="/virtual-dom" style={styles.navLinkActive}>虚拟DOM表格</Link>
            </nav>
          </div>
        )}
      </div>
